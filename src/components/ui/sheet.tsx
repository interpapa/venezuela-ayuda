...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-3 top-3 rounded-md bg-white/90 p-1.5 text-muted-foreground opacity-90 transition hover:opacity-100 focus:outline-none">
